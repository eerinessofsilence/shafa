...
def _run_embedded_shafa_cli(argv: list[str]) -> int | None:
    ...
    try:
        ...
        shafa_main.main(
            ...
            deactivate_old_products_once=parsed_args.deactivate_old_products_once,
            old_products_age_days=parsed_args.old_products_age_days,
            old_products_limit=parsed_args.old_products_limit,
            old_products_sleep_seconds=parsed_args.old_products_sleep_seconds,
            old_products_dry_run=parsed_args.old_products_dry_run,
            shared_deactivation_plan_once=parsed_args.shared_deactivation_plan_once,

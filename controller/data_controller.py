...
DEFAULT_DESCRIPTION = (
    "Продам зручні та стильні кросівки в хорошому стані. "
    "Легкі, добре дихають, забезпечують комфорт під час щоденного носіння. "
    "Підійдуть для прогулянок, роботи або активного відпочинку. "
    "Без значних дефектів, чисті та доглянуті."
)

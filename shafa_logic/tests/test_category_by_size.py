...
class CategoryBySizeTests(unittest.TestCase):
    ...
    @patch("controller.data_controller._resolve_brand_id", return_value=104)
    ...
    def test_build_product_raw_data_replaces_masked_brand_in_name(
        self,
        _resolve_size_id,
        _parse_price,
        _resolve_brand_id,
